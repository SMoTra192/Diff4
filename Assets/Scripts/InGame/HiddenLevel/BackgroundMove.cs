...
public class BackgroundMove : MonoBehaviour
{
    ...
    private void Awake()
    {
        mapMinX = mapRenderer.transform.position.x - mapRenderer.sprite.bounds.size.x / 2f;
        mapMaxX = mapRenderer.transform.position.x + mapRenderer.sprite.bounds.size.x / 2f;

        mapMinY = mapRenderer.transform.position.y - mapRenderer.sprite.bounds.size.y / 2f;
        mapMaxY = mapRenderer.transform.position.y + mapRenderer.sprite.bounds.size.y / 2f;
    }
